...
using System.Text;
namespace AdminApplication2.Controllers
{
    public class HealthExaminationController : Controller
    {
        public HealthExaminationController()
        {
        ...
        public IActionResult Index()
        {
            ...
            string URL = "https://localhost:7052/api/Admin/GetAllHealthExaminations";
        ...
        public IActionResult Details(string id)
        {
            HttpClient client = new HttpClient();
            //added in next aud
            string URL = "https://localhost:7052/api/Admin/GetDetailsForHealthExamination";
            var model = new
            {
                Id = id
            };
        ...
        public IActionResult ImportExaminationsMain(IFormFile file)
        {
            ...
            HttpClient client = new HttpClient();
            string URL = "https://localhost:7052/api/Admin/ImportExaminations";
        ...
        private List<HealthExamination> getAllExaminationsfromFile(string fileName)
        {
            ...
            using (var stream = System.IO.File.Open(filePath, FileMode.Open, FileAccess.Read))
            {
                using (var reader = ExcelReaderFactory.CreateReader(stream))
                {
                    while (reader.Read())
                    {
                        users.Add(new HealthExamination
                        {
